    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">Manage your platform and monitor user activity</p>
        </motion.div>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{stats.totalSwaps || 0}</p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-6">
            ...
            {activeTab === 'reports' && (
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-4">Reports & Issues</h3>
                <div className="text-center py-8">
                  <AlertTriangle className="w-12 h-12 text-gray-400 mx-auto mb-4" />
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No pending reports</h3>
                  <p className="text-gray-500">All issues have been resolved.</p>
                </div>
              </div>
            )}
