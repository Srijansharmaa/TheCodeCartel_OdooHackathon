          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600">
                Find people with the skills you need and connect with them directly.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                Expand your knowledge by learning from experienced professionals.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                Create lasting connections through mutual skill sharing.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            ...
            >
              ...
              <div className="text-gray-600">Skills Offered</div>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, scale: 0.8 }}
              whileInView={{ opacity: 1, scale: 1 }}
